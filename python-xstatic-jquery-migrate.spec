...
Version:        XXX
Release:        1%{?dist}
Summary:        JQuery_Migrate JavaScript library packaged for setuptools

License:        MIT
URL:            http://git.openstack.org/cgit/stackforge/xstatic-jquery-migrate/
...
%description
JQuery_Migrate javascript library packaged for
...
%{python_sitelib}/xstatic/pkg/jquery_migrate
